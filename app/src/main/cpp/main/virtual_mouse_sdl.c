...
Java_com_app_ralaunch_feature_controls_bridges_SDLInputBridge_nativeInitVirtualMouseSDL(
...
Java_com_app_ralaunch_feature_controls_bridges_SDLInputBridge_nativeGetVirtualMousePositionSDL(
 ...
 */
JNIEXPORT void JNICALL
Java_com_app_ralaunch_feature_controls_bridges_SDLInputBridge_nativeSetVirtualMouseRangeSDL(
 ...
 */
JNIEXPORT void JNICALL
Java_com_app_ralaunch_feature_controls_bridges_SDLInputBridge_nativeUpdateVirtualMouseDeltaSDL(
 ...
 */
JNIEXPORT void JNICALL
Java_com_app_ralaunch_feature_controls_bridges_SDLInputBridge_nativeSetVirtualMousePositionSDL(
...
Java_com_app_ralaunch_feature_controls_bridges_SDLInputBridge_nativeGetVirtualMouseXSDL(
    JNIEnv *env, jclass clazz) {
    // 自动初始化虚拟鼠标（如果未初始化）
    ensure_virtual_mouse_initialized(1920, 1080);
    return g_vm_x;
 ...
 */
JNIEXPORT float JNICALL
Java_com_app_ralaunch_feature_controls_bridges_SDLInputBridge_nativeGetVirtualMouseYSDL(
    JNIEnv *env, jclass clazz) {
    // 自动初始化虚拟鼠标（如果未初始化）
    ensure_virtual_mouse_initialized(1920, 1080);
    return g_vm_y;
...
Java_com_app_ralaunch_feature_controls_bridges_SDLInputBridge_nativeIsVirtualMouseActiveSDL(
    JNIEnv *env, jclass clazz) {
