...
object RendererRegistry {
    ...
    fun getRendererDisplayName(rendererId: String): String {
        ...
        return when (normalized) {
            ID_NATIVE -> getSharedString(R.string.renderer_native, normalized)
            ID_GL4ES -> getSharedString(R.string.renderer_gl4es, normalized)
    ...
    fun getRendererDescription(rendererId: String): String {
        val normalized = normalizeRendererId(rendererId)
        return when (normalized) {
            ID_NATIVE -> getSharedString(R.string.renderer_native_desc)
            ID_GL4ES -> getSharedString(R.string.renderer_gl4es_desc)
    ...
    private fun getSharedString(@StringRes resource: Int, fallback: String = ""): String {
        return runCatching { getAppString(resource) }.getOrElse { fallback }
    }
}
